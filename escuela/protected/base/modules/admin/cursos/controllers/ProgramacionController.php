...
use base\modules\admin\cursos\models\CursoProgramacion as DbModel;

class ProgramacionController extends \base\Controller
{
	public $model;
	public $modelCurso;
	...
	public function actionUpdate($id)
	{
		...
		$this->view->H1        = Yii::t('app','Editar Programación');
		...
		if(Yii::$app->request->isPost)
		{
			...
			return $this->asJson([
				...
				'statusText' => $statusText = Yii::t('app', '<h5 class="margin-v-15">Programacion <b>{nombre}</b> modificado exitosamente!</h5>', ['nombre' => $this->model->titulo ]),
			]);
		}

		return $this->renderAjax('@moduleLayouts/curso-programacion/form');
	}
	...
	public function actionCreate()
	{
		...
		if(Yii::$app->request->isPost)
		{
			...
			return $this->asJson([
				...
				'statusText' => $statusText = Yii::t('app', '<h5 class="margin-v-15">Nueva programación <b>{nombre}</b> creada exitosamente!</h5>', ['nombre' => $this->model->titulo ]),
			]);
		}
	...
	public function actionDelete($id)
	{
		...
		$counts = DbModel::find()->select('id')->where('id_curso =:id_curso', [
