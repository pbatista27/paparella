...
use base\modules\admin\cursos\models\Examen as DbModel;

class ExamenesController extends \base\Controller
{
	public $model;
	public $modelCurso;
	...
	public function actionUpdate($id)
	{
		...
		if(Yii::$app->request->isPost)
		{
			...
			return $this->asJson([
				...
				'statusText' => $statusText = Yii::t('app', '<h5 class="margin-v-15">Examen <b>{nombre}</b> modificado exitosamente!</h5>', ['nombre' => $this->model->nombre ]),
			]);
		}
	...
	public function actionCreate()
	{
		...
		if(Yii::$app->request->isPost)
		{
			...
			return $this->asJson([
				...
				'statusText' => $statusText = Yii::t('app', '<h5 class="margin-v-15">Nuevo examen <b>{nombre}</b> creado exitosamente!</h5>', ['nombre' => $this->model->nombre ]),
			]);
		}
