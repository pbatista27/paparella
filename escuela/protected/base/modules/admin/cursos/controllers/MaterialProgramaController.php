...
use base\modules\admin\cursos\models\MaterialPrograma as DbModel;

class MaterialProgramaController extends \base\Controller
{
	public $model;
	public $modelCurso;
	...
	public function actionUpdate($id)
	{
		...
		$this->view->H1        = Yii::t('app','Editar material programa');
		...
		if(Yii::$app->request->isPost)
		{
			...
			return $this->asJson([
				...
				'statusText' => $statusText = Yii::t('app', '<h5 class="margin-v-15">Material programa <b>{nombre}</b> modificado exitosamente!</h5>', ['nombre' => $this->model->nombre ]),
			]);
		}
	...
	public function actionCreate()
	{
		...
		if(Yii::$app->request->isPost)
		{
			...
			return $this->asJson([
				...
				'statusText' => $statusText = Yii::t('app', '<h5 class="margin-v-15">Nuevo material <b>{nombre}</b> creado exitosamente!</h5>', ['nombre' => $this->model->nombre ]),
			]);
		}
