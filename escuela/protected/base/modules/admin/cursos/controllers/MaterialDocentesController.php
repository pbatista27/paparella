...
use base\modules\admin\cursos\models\MaterialDocente as DbModel;

class MaterialDocentesController extends \base\Controller
{
	public $model;
	public $modelCurso;
	...
	public function actionUpdate($id)
	{
		...
		$this->view->H1        = Yii::t('app','Editar material para docentes');
		...
		if(Yii::$app->request->isPost)
		{
			...
			return $this->asJson([
				...
				'statusText' => $statusText = Yii::t('app', '<h5 class="margin-v-15">Material para docentes <b>{nombre}</b> modificado exitosamente!</h5>', ['nombre' => $this->model->nombre ]),
			]);
		}
	...
	public function actionCreate()
	{
		...
		if(Yii::$app->request->isPost)
		{
			...
			return $this->asJson([
				...
				'statusText' => $statusText = Yii::t('app', '<h5 class="margin-v-15">Nuevo material para docentes <b>{nombre}</b> creado exitosamente!</h5>', ['nombre' => $this->model->nombre ]),
			]);
		}
