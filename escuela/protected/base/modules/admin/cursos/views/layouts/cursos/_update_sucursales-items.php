...
<div class="container-fluid" id="loader-<?= $ckTarget ?>">
	<div class="row">
		<div class="col-md-12">
	...
	<div class="row">
		<?php
			foreach($sucursales as  $item):
				$item     = (object) $item;
				$checked  = in_array($item->id, $sucursalesActivas) ? 'checked="checked"' : null;
		?>
		<div class="col-sm-4">
			<div class="pull-left" style="margin-right:15px;margin-bottom:10px">
				<input  type="checkbox" data-target="<?= $ckTarget ?>" name="<?= $item->id ?>" value="1"  <?= $checked ?> style="width:23px; height:23px">
			</div>
			<div class="pull-left">
