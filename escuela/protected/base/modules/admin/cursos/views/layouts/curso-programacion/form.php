...
<div class="container-fluid padding-v-15">
    <div class="row">
            <?php
                echo $form->field($this->context->model, 'titulo', [ 'inputOptions' => ['autocomplete' => 'off'] , 'options' => ['class' => 'col-xs-12 col-sm-12 col-md-12']])->textInput(['placeholder'=>$this->context->model->getAttributeLabel('titulo')]);
                echo $form->field($this->context->model, 'nro_dias', [ 'inputOptions' => ['autocomplete' => 'off'] , 'options' => ['class' => 'col-xs-12 col-sm-12 col-md-12']])->textInput(['placeholder'=>$this->context->model->getAttributeLabel('nro_dias')]);
            ?>
    </div>
    <div class="row">
        <?php
            echo $form->field($this->context->model, 'descripcion', [ 'inputOptions' => ['autocomplete' => 'off'] , 'options' => ['class' => 'col-xs-12 col-sm-12 col-md-12']])->textArea(['placeholder'=>$this->context->model->getAttributeLabel('descripcion')]);
        ?>
    </div>
    <div class="row">
        <div class="col-md-12 text-right  margin-v-15">
            <?php
                echo Html::submitButton(Yii::t('app','Aceptar'), ['class' => 'btn btn-primary']);
            ?>
        </div>
    </div>
</div>
