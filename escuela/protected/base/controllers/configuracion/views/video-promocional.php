...
<div class="container-fluid padding-v-15">
    <div class="row">
		<?php echo $form->field($this->context->model, 'youtube',   [ 'inputOptions' => ['autocomplete' => 'off'] , 'options' => ['class' => 'col-xs-12 col-sm-12 col-md-12']])->textInput(['placeholder'=>$this->context->model->getAttributeLabel('youtube')]); ?>
    </div>
    <div class="row">
