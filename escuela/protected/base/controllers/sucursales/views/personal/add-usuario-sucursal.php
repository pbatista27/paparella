 <?php
    ...
    $this->registerJs(
        '
            ...
            function addUserSucursal(element){

            	var item = $(element).data("item");
            	modal.addLoader();
            	$.ajax({
            		url  : "'.  Url::toRoute([$this->context->currentController . '/'. $this->context->currentAction , 'idSucursal' => $sucursal->id ]) .'",
					data : {index : item},
					type : "POST",
            	})
            	.always(function(){
